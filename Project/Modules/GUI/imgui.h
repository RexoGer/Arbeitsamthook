...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, ImVec4 DetailColor = ImVec4(0.25f, 0.25f, 0.25f, 1.00f));
    IMGUI_API bool          OriginalCheckbox(const char* label, bool* v);
    IMGUI_API bool          Joystick(ImVec2 Position, const char* Id);
    IMGUI_API bool          Trigger(float Position, const char* Id);
    IMGUI_API bool          Hotkey(const char* label, int* k, ImVec4 DetailColor, const ImVec2& size_arg = ImVec2(0, 0));
